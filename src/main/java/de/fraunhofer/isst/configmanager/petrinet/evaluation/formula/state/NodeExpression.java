...
/**
 * Custom Expression to be evaluated on a {@link de.fraunhofer.isst.configmanager.petrinet.model.Place}
 */
@Getter
@AllArgsConstructor
public class NodeExpression {
    ...
    /**
     * Subexpression (function from {@link de.fraunhofer.isst.configmanager.petrinet.model.Place} to boolean
     */
